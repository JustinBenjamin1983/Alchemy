            ...
            <div
              ...
              className={`group flex items-start gap-2 px-4 py-2.5 border-l-4 transition-all cursor-pointer ${
                selectedFindingId === finding.id
                  ? 'border-blue-500 bg-blue-50 dark:bg-slate-800 shadow-md ring-1 ring-blue-200 dark:ring-blue-800'
                  : focusedFindingId === finding.id
                  ? 'border-blue-400 bg-blue-50 dark:bg-slate-800/50'
                  : 'border-transparent hover:bg-gray-100 dark:hover:bg-slate-800/50 hover:border-gray-300'
              }`}
...
export const FindingsList: React.FC<ExtendedFindingsListProps> = ({
  ...
  return (
    <div className="flex flex-col h-full" ref={listRef} tabIndex={0}>
      {/* Header */}
      <div className="flex-shrink-0 px-4 py-3 border-b border-gray-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 text-sm border border-gray-200 dark:border-slate-600 rounded bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>
      </div>
