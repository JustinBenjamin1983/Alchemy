  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="h-8 flex items-center justify-between px-2.5 text-left bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:border-gray-400 dark:hover:border-gray-500 transition-colors"
      >
        {selectedRun ? (
      ...
      {isOpen && (
        <div className="absolute z-50 mt-1 min-w-max bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg overflow-hidden">
