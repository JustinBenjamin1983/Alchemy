  ...
  if (activeTab === 'executive_summary') {
    return (
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-300 dark:border-slate-700 p-6">
    ...
    return (
      <div className="max-w-4xl mx-auto">
        ...
        {assessment.blocking_issues && assessment.blocking_issues.length > 0 && (
          <div className="mb-6 bg-white dark:bg-slate-800 rounded-lg border border-gray-300 dark:border-slate-700 p-6">
    ...
    return (
      <div className="max-w-4xl mx-auto">
        ...
        {exposures.items && exposures.items.length > 0 && (
          <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-300 dark:border-slate-700 overflow-hidden">
        ...
        {blockers.length === 0 ? (
          ...
          <div className="space-y-4">
            {blockers.map((blocker, index) => (
              <div key={index} className="bg-white dark:bg-slate-800 rounded-lg border border-red-200 dark:border-red-800 overflow-hidden">
  ...
  if (activeTab === 'conditions_precedent') {
    ...
    return (
      <div className="max-w-4xl mx-auto">
        ...
        {cps.length === 0 ? (
          <div className="p-6 bg-gray-50 dark:bg-slate-800 rounded-lg border border-gray-300 dark:border-slate-700 text-center">
            <ClipboardListIcon />
        ...
        {recommendations.length === 0 ? (
          ...
          <div className="space-y-4">
            {recommendations.map((rec, index) => (
              <div key={index} className="flex items-start gap-4 p-4 bg-white dark:bg-slate-800 rounded-lg border border-gray-300 dark:border-slate-700">
